...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-[#0d1117] border-r border-gray-800 flex flex-col min-h-screen">
      {/* Logo */}
      <div className="p-6 border-b border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-white">MiPortafolio</h1>
            <p className="text-xs text-gray-500">Quant Analysis</p>
          </div>
        </div>
      </div>
